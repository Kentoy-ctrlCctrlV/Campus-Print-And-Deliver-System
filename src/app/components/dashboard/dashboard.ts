  ...
  constructor(private router: Router, private orderService: OrderService) {
    if (typeof window !== 'undefined' && window.localStorage) {
      ...
      if (savedEmailOrPhone) {
        ...
        this.orderService.setStudentInfo(savedEmailOrPhone);
        // Load orders from API for this student
        this.orderService.loadOrdersForStudent(savedEmailOrPhone).subscribe();
      }
    }
